...
Version 0.0.0\quad\date{2025-12-31}
...
\begin{code}{\clock}
  ...
  in path \key{clock} for only that particular usage of \cs{clock}.
...
\begin{code}{\calendardate}
  ...
  If the optional argument is used, the keys in \meta{key-value list} are set
  in path \key{date} for only that particular usage of \cs{calendardate}.
...
Set the package keys using \cs{clockdatesetup}\marg{key-value list}
(\S\ref{sec:commands}).
...
\begin{code}{clock/star}
  ...
  list} in path \key{clock} will be set for only that particular usage of
  \cs{clock}.
...
\begin{code}{clock/range-separator}
  ...
  \end{syntax}
  Sets the separator between \meta{clock_1} and \meta{clock_2} in a time of
  day range to \meta{token list}.
...
\begin{code}{date/star}
  ...
  \meta{key-value list} in path \key{date} will be set for only that
  particular usage of \cs{calendardate}.
  The initial value is \meta{empty}.
\end{code}
...
\begin{code}{days/days-final-separator}
  \begin{syntax}
...
\begin{code}{date/months-range-separator}
  ...
  \end{syntax}
  Sets the separator between \meta{month_1} and \meta{month_2} in a month
